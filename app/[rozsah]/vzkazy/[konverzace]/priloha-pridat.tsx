...
const NEJDELSI_STRANA_PX = 2000
const KVALITA_JPEG = 0.85
/** Fotky pod tuhle velikost (a v povoleném typu) se nezmenšují, ať se zbytečně neztrácí kvalita. */
const NEMENIT_DO_BAJTU = 1.5 * 1024 * 1024
...
async function zmensitObrazek(soubor: File): Promise<Blob | null> {
  try {
