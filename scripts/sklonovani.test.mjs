...
ma('přísudek u jednoho', prisudek(1, 'není dokončený', 'nejsou dokončené'), 'není dokončený')
ma('přísudek u dvou', prisudek(2, 'není dokončený', 'nejsou dokončené'), 'nejsou dokončené')
ma('přísudek u pěti', prisudek(5, 'není dokončený', 'nejsou dokončené'), 'nejsou dokončené')
