 ...
 * Rozpoznané menu.
 *
 * `price_cents` je v HALÉŘÍCH jako `integer` (CLAUDE.md, Konvence) a
 * NULL znamená „nerozpoznáno", ne nula. Nula by byla cena zdarma.
 */
export type MenuRozpoznanaPolozka = {
  category: string
  name: string
  description: string
